...
/*#define FLOWS_REGISTER register<bit<REGISTER_CELL_BIT_WIDTH>>(REGISTER_LENGTH) flows_register
#define COUNT_REGISTER register<bit<REGISTER_CELL_BIT_WIDTH>>(1) count_register*/
...
control MyIngress(inout headers hdr,
    ...
    /*action flow_check(bit<16> maxFlows, bit<16> minFlows) {
        count_register.read(meta.flow_count, (bit<32>)0);
        if (meta.flow_count >= maxFlows){
            standard_metadata.egress_spec = CPU_PORT;
            clone(CloneType.I2E, (bit<32>)500);
        }
    }*/
    ...
    apply {
        if (standard_metadata.ingress_port == CPU_PORT) {
            ...
            timeout_register.read(meta.timestamp, (bit<32>)2);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)3);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)4);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)5);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)6);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)7);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)8);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)9);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)10);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)11);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)12);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)13);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)14);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            timeout_register.read(meta.timestamp, (bit<32>)15);
            if (meta.timestamp != (bit<48>)0){
                if (standard_metadata.ingress_global_timestamp - meta.timestamp == (bit<48>)4000000){
                    meta.flow_count = meta.flow_count - 1;
                    timeout_register.write((bit<32>)0, 0);
            ...
            if (meta.flow_count >= 3){
                hdr.packet_in.code = (bit<16>) 600;
            }
            
            if (meta.flow_count <= 2){

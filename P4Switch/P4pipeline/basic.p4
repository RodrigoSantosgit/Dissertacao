    ...
    apply {
        if (standard_metadata.ingress_port == CPU_PORT) {
            ...
            if (meta.inc_flowid == meta.service_id){
                hash(meta.flows_index1, HashAlgorithm.crc16, (bit<16>)0, {standard_metadata.ingress_port, hdr.ipv4.srcAddr, hdr.ipv4.dstAddr, hdr.ipv4.protocol}, (bit<16>) REGISTER_LENGTH);
